...
Scans the dataset and produces `index/master_index_{basin}.csv` for all 6 basins (WP, EP, NA, NI, SI, SP).
...
Produces track predictions, regression residual analysis, scatter plots, cross-basin decadal intensity trends, climate change statistical analysis, and per-storm summary tables.
